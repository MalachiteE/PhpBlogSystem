...
<div class="SubmitForm row">
    ...
    <form class="SubmitForm__form col push-s4 s4" action="http://localhost/PhpBlogSystem/route.php?module=Tank&method=insert" method="post" enctype="multipart/form-data">
        <div class="row">
